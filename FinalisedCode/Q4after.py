...
line= go.Scattermapbox(
        lat=[latA, latD, latC, latF],
        lon=[lonA, lonD, lonC, lonF],
        mode = 'lines',
	...
	text=["Kuala Lumpur", "India", "London","United States"],
    ),
layout = go.Layout(
    autosize=True,
    hovermode='closest',
    ...
    title = go.layout.Title(
        text = 'After The Chosen Route'
    ),
)

fig = go.Figure(data = line, layout = layout)
ply.plot(fig, filename='route-after.html')